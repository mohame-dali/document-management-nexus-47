        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="bg-[#2c5282] hover:bg-[#2a4365] text-white rounded font-medium gap-2 h-10 px-5 transition-colors duration-200"
            >
              {saving ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3.5">
          ...
          <div className="space-y-1 flex flex-col justify-end">
            <Button
              ...
              className="h-10 border-[#e2e8f0] text-[#2c5282] hover:bg-[#f7fafc] rounded font-medium gap-2 text-xs"
            >
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex items-center gap-2 bg-gray-50 border border-[#e2e8f0] p-1 rounded">
                        <button
                          ...
                          className={`h-9 px-3.5 rounded text-xs font-bold transition-all duration-200 flex items-center gap-1.5 ${
                            isPresent
