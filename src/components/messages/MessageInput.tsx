    ...
    <div className="border-t border-[#e2e8f0] bg-white p-3 sm:p-4">
      ...
      <div className="flex items-end gap-2">
        ...
        <Button
          ...
          disabled={disabled}
          className="h-10 w-10 shrink-0 text-slate-500 hover:text-[#2c5282] hover:bg-[#f7fafc] rounded-lg transition-colors"
          title="إرفاق ملف"
        >
        ...
        <Button
          ...
          className="h-10 w-10 shrink-0 rounded-lg bg-[#2c5282] hover:bg-[#234269] text-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 flex items-center justify-center shadow-xs"
          title="إرسال (Enter)"
        >
